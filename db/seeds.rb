...
nick = User.create!(name: "Nick Brown", email: "nick.brown2014@gmail.com", password: "catscats", picture_url: "https://dl-web.dropbox.com/get/Wolves%202014/Nick.jpg?_subject_uid=45230430&w=AADvam2SfFcMAADmwLO2DAY07JbpVyV6wzDU_vyTbwEGhg)", bio: "Hey there, I'm Nick! I am originally from Cincinatti, OH and recently came to Chicago to attend Dev BootCamp (GO WOLVES!). I enjoy practing yoga, coding, and hanging out with friends. PairBnB is awesome, so you should message me if you're in the Cincinatti area and need a couch to crash on. I've got a couple projects that could use an extra set of eyes.", specialties: "Ruby, JavaScript, RoR, Web sockets",github_url: "nick-brown2014", twitter_url: "SunnyBrownCC")
...
michael = User.create!(name: "Michael Steichen",  email: "michael.steichen@gmail.com", password: "password", picture_url: "https://dl-web.dropbox.com/get/Wolves%202014/Michael%20S..jpg?_subject_uid=45230430&w=AACI3-IJNHXfaZfrVK5lITx6sFmLf8hKd0s63Rz4PuZQ6g"), bio:"Hi hello! My friends call me 'mikesteich' cause it rhymes that way. I grew up in Tulsa, Oklahoma and moved to Chicago in 2006. Before I arrived at Dev Bootcamp, I was working in Chicago's specialty coffee scene as a trainer and quality controller. PairBnB is awesome, so you should message me if you're in the Chicago area and need a couch to crash on. I've got a couple projects that could use an extra set of eyes.", specialties: "RoR, Schemas, Postgres, Brewing Coffee", github_url: "mjsteichen", twitter_url: "MeikSteich")
